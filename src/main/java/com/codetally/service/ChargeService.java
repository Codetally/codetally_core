    ...
    public void synchChargesByOwnernameAndRepo(String ownername, String repo) {
        try {
            ...
            if (url != null) {
                ...
                Gson gson = new Gson();
                Codecost codecost = gson.fromJson(new InputStreamReader(urlconnection.getInputStream(), "utf-8"), Codecost.class);
    ...
    public float calculateTimeCharge(Commit commit, long repositoryId, String owner, String repo) {
        ...
        try {
            ...
            if (url != null) {
                ...
                Gson gson = new Gson();
                Timelog timelog = gson.fromJson(new InputStreamReader(urlconnection.getInputStream(), "utf-8"), Timelog.class);
